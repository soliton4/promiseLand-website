(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    ...
    define("codemirror4/mode/sass/sass", ["../../lib/codemirror"], mod);
...
CodeMirror.defineMode("sass", function(config) {
  ...
  var buildStringTokenizer = function(quote, greedy){
    ...
    function stringTokenizer(stream, state){
      ...
      /*
      0 && console.log("previousChar: " + previousChar);
      0 && console.log("nextChar: " + nextChar);
      0 && console.log("peekChar: " + peekChar);
      0 && console.log("ending: " + endingString);
      */
