define("sol/wgt/node/debug/Protocol", [
  "dojo/_base/declare"
  , "dojo/json"
  , "dojo/Deferred"
  , "dojo/_base/lang"
  ...
  return declare([], {
    ...
    , parseBody: function(){
      if (this.bufStr.length >= this.contentLength){
        ...
        //0 && console.log(this.bufStr.length + " from " + this.contentLength);
      };
    }
    ...
    , _parseHead: function(){
      ...
      for (i = 0; i < headAr.length; ++i){
        ...
        if (dpPos > -1){
          ...
          0 && console.log("ignored header line:" + headAr[i]);
        };
      };
    }
    ...
    , _newMsg: function(parMsg){
      ...
      0 && console.log("unknown Message:" + parMsg.body);
    }
    
    , _handleEvent: function(parEvent){
      //0 && console.log(parEvent);
      //0 && console.log(parEvent.event);
    ...
    , _handleResponse: function(parMsg){
      if (this._responseHandler[parMsg.command]){
        ...
        0 && console.log("no response Handler for:");
        0 && console.log(parMsg);
      };
    }
    ...
    , _expectResponse: function(par){
      ...
      if (this._responseHandler[par.command]){
        0 && console.log("trying to double handle response");
      };
