...
var Base = oo.declare(
	function(options){
		//0 && console.log("______Base", this.type, options)
		...
		//0 && console.log("BASE OPTS:", options)
		if(options.points){
			//0 && console.log("__________Base.constr >>>> ", this.type, "points", options.points)
			...
			//0 && console.log("___________Base.constr", this.type, "options data", options.data)
			...
			//0 && console.log("_____________Base.constr", this.type, "draws")
			this.points = [];
			this.data = {};
			this.connectMouse();
	...
	},
	{
		...
		onDelete: function(/* Stencil */ stencil){
			...
			0 && console.info("onDelete", this.id);
		},
		...
		onRender: function(/*Object*/ stencil){
			...
			//0 && console.warn("ONRENDER", this.id, this)
		},
		...
		animate: function(options, create){
			...
			if(dojo.isArray(options.start)){
				...
				0 && console.warn("No data provided to animate")
			}
