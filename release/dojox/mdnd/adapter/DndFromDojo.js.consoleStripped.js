define("dojox/mdnd/adapter/DndFromDojo", ["dojo/_base/kernel",
		...
		null,
	{
		...
		subscribeDnd: function(){
			...
			//0 && console.log(("dojox.mdnd.adapter.DndFromDojo ::: subscribeDnd");
		...
		unsubscribeDnd: function(){
			...
			//0 && console.log(("dojox.mdnd.adapter.DndFromDojo ::: unsubscribeDnd");
		...
		_getHoverArea: function(/*Object*/ coords){
			...
			//0 && console.log("dojox.mdnd.adapter.DndFromDojo ::: _getHoverArea");
			var x = coords.x;
			var y = coords.y;
			...
			//0 && console.log("dojox.mdnd.adapter.DndFromDojo ::: _getHoverArea",this._dojoManager.avatar.node,this._currentArea,this._oldArea);
		},
		...
		onDragStart: function(/*Object*/source, /*Array*/nodes, /*Boolean*/copy){
			...
			//0 && console.log("dojox.mdnd.adapter.DndFromDojo ::: onDragStart");
		...
		onMouseMove: function(/*DOMEvent*/e){
			...
			//0 && console.log("dojox.mdnd.adapter.DndFromDojo ::: onMouseMove");
		...
		onDragEnter: function(){
			...
			//0 && console.log("dojox.mdnd.adapter.DndFromDojo ::: onDragEnter");
		...
		onDragExit: function(){
			...
			//0 && console.log("dojox.mdnd.adapter.DndFromDojo ::: onDragExit");
		...
		isAccepted: function(/*Node*/node, /*Object*/accept){
			...
			//0 && console.log("dojox.mdnd.adapter.DndFromDojo ::: isAccepted");
		...
		onDndSource: function(/*Object*/ source){
			...
			//0 && console.log("dojox.mdnd.adapter.DndFromDojo ::: onDndSource",source);
		...
		_resetAvatar: function(){
			...
			//0 && console.log("dojox.mdnd.adapter.DndFromDojo ::: _resetAvatar");
			if(this._dojoManager.avatar){
				if(this._areaManager._accept){
					domClass.add(this._dojoManager.avatar.node, "dojoDndAvatarCanDrop");
				}
		...
		onDropCancel: function(){
			...
			//0 && console.log("dojox.mdnd.adapter.DndFromDojo ::: onDropCancel");
			if(this._currentArea == null){
		...
		onDrop: function(/*Object*/source, /*Array*/nodes, /*Boolean*/copy){
			...
			//0 && console.log("dojox.mdnd.adapter.DndFromDojo ::: onDrop", this._currentArea);
			connect.disconnect(this._moveHandler);
			connect.disconnect(this._outSourceHandler);
			this._moveHandler = this._outSourceHandler = null;
